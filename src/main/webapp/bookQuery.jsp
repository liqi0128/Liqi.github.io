                        ...
                        <table width="98%" height="487" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <form action="" id="BookQuery" method="post" name="form1">
                                        <table width="98%" height="38" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#F9D16B">请选择查询依据：
                                                    ...
                                                    <input name="Submit" type="button" onclick="SubmitBookQuery()" class="btn_grey" value="查询"></td>
                                            </tr>
                                        </table>
                                        ...
                                        <%--<table width="98%" border="1" cellpadding="0" cellspacing="0"--%>
                                            ...
                                            <%--<tr>--%>
                                                ...
                                                <%--<td style="padding:5px;"><a href="book.do?action=bookDetail&ID="></a>--%>
                                                <%--</td>--%>
                                                <%--<td style="padding:5px;">&nbsp;</td>--%>
                                                <%--<td style="padding:5px;">&nbsp;</td>--%>
                                                <%--<td style="padding:5px;">&nbsp;</td>--%>
