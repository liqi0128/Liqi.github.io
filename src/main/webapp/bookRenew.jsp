...
<script src="JS/bookRenew.js"></script>
    ...
    <td align="center" valign="top" style="padding:5px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#F8BF73"><table width="96%" border="0" cellpadding="1" cellspacing="1" bordercolor="#F8BF73">
				...
				<form name="form1" method="post" action="borrow.do?action=bookrenew">
                  ...
                  <tr>
                    <td align="center"><table width="96%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="27">姓&nbsp;&nbsp;&nbsp;&nbsp;名：
                            <input name="readername" type="text" readonly="readonly" id="readername" value=""></td>
                          <td>性&nbsp;&nbsp;&nbsp;&nbsp;别：
                            <input name="sex" type="text" id="sex" readonly="readonly" value=""></td>
                          <td>读者类型：
                            <input name="readerType" type="text" readonly="readonly" id="readerType" value=""></td>
                        </tr>
                        <tr>
                          <td height="27">证件类型：
                            <input name="paperType" type="text" readonly="readonly" id="paperType" value=""></td>
                          <td>证件号码：
                            <input name="paperNo" type="text" readonly="readonly" id="paperNo" value=""></td>
                          <td>可借数量：
                            <input name="number" type="text" readonly="readonly" id="number" value="" size="17">
                            册
                            &nbsp;</td>
                        </tr>
                    </table></td>
          ...
          <tr>
            <td valign="top">
                <table id="BorrowList" width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
