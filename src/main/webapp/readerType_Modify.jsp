...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg">
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><form name="form1" method="post" id="readerTypeModify">
 <input name="id" type="hidden" size="50" value="" id="id" >
  ...
  <tr>
    ...
    <td width="72%"><input name="name" type="text" size="28" value="" id="name">
      </td>
  </tr>
  <tr>
    <td align="center">可借数量：</td>
    <td><input name="number" type="text" size="25" value="" id="number">
      (本)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
